# ============================================================
# MULTI-COIN REVERSE-TENKAN SIGNAL BOT v1.5
# ============================================================
#
...
#   LTC, BCH, UNI, AAVE, SUI, HYPE, NEAR, ATOM, FIL,
#   ARB, OP, ZEC
#
# Telegram:
#   Reports all symbols
#   Reports why no signal was generated
#
# REAL TRADING:
#   DISABLED
#
# IMPORTANT:
#   Strategy calculation logic is unchanged.
#   Only multi-symbol support and independent state
...
STATE_FILE = "reverse_tenkan_multi_state.json"
...
def main():
    ...
    print(
        "MULTI-COIN REVERSE-TENKAN v1.5"
    )
    ...
    for symbol in SYMBOLS:
        ...
        try:
            ...
            # ------------------------------------------------
            # DO NOT OPEN NEW TRADE WHILE
            # THIS SYMBOL HAS ONE ACTIVE
            # ------------------------------------------------
    ...
    print()
    print("=" * 70)
    print("MULTI-COIN CHECK COMPLETE")
    print("=" * 70)
